    ...
    <div class="collect-page">
      ...
      <div class="collect-toolbar">
        <div class="collect-toolbar__left">
          <div class="collect-toolbar__title">Vecteezy 控制台</div>
          <el-select
          ...
          <div v-if="selectedClient" class="collect-panel">
            ...
            <div class="status-hero">
              <div class="hero-main" :class="`is-${availabilityTone}`">
                <div class="hero-eyebrow">Vecteezy (免版税素材库)</div>
...
const clients = computed<VecteezyClientVO[]>(() => {
  return rawClients.value.map((c) => {
    const rawService = getServiceRuntime(c.clientId) as VecteezyServiceStatus | null;

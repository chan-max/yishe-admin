...
<template>
  <div class="wf-node wf-node--emojipedia">
    ...
    <div class="wf-node__header">
      <img :src="emojipediaIcon" class="wf-node__icon" /><span class="wf-node__title">{{
        data.label || "Emojipedia 采集"
      }}</span>
    </div>
...
.wf-node--emojipedia .wf-node__header {
  display: flex;
  align-items: center;
  gap: 6px;
  margin-bottom: 4px;
}
.wf-node--emojipedia .wf-node__icon {
  width: 16px;
  height: 16px;
  object-fit: contain;
}
.wf-node--emojipedia .wf-node__title {
  font-weight: 600;
  color: var(--app-text-color);
}
.wf-node--emojipedia .wf-node__subtitle {
  font-size: 11px;
  color: #e67e22;
  background: #fef5e7;
  padding: 2px 6px;
...
.wf-node--emojipedia .wf-node__badge {
  font-size: 10px;
...
.wf-node--emojipedia .wf-node__type {
  font-size: 10px;

<template>
  <el-select v-bind="$attrs" :remote-method="remoteMethod" style="width: 100%" :placeholder="placeholder" clearable
    filterable remote  >
...
import { getAutoPublishList } from "@/api/publish";
